    ...
    <Helmet>
        ...
        <div className=" lg:w-1/2 sm:w-screen mt-2  px-4   ">
          ...
          <p className="px-2 text-2xl  font-sans mt-6 ">
            ...
            cutting edge technology! <br></br><br></br>I currently work as a Backend Engineer. Currently im learning both frontend and backend in hopes of becoming a full stack. I seek opportunities
