...
function homepage() {
  return (
    ...
    <Suspense fallback= {<div className= 'object-cover w-full h-full min-w-full min-h-full -z-50 ' role="status">
    <svg className="  text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
