  ...
  return (
    <div className="flex my-16">
      <Helmet>
        ...
        <meta
          name="Projects"
          content="Jacob Elali portfolio software engineer projects hobby android java javascript web developer sydney australia"
        />
      </Helmet>
      ...
      <div className="lg:ml-20    px-4  text-2xl lg:w-1/2 w-auto ">
        ...
        <div className="mt-12 block p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
          ...
          <p className="  font-sans mt-10 ">
            <b>This Website</b>
            <br></br>
            <br></br> This website is made purely with React and Tailwind. I
            used Three.js is used to render the cute wallE model in the 'About
            Me' section. I've used tailwind to style and make the site
            responsive to most devices. This website was built to serve as my
